...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        teamMedicalDragon.addMenber(ryutarou);
        teamMedicalDragon.addMenber(miki);
        teamMedicalDragon.addMenber(keisuke);
        teamMedicalDragon.addMenber(monji);
        ...
        doctorX.addMenber(michiko);
        doctorX.addMenber(hiromi);
        doctorX.addMenber(hideki);
        doctorX.service();
        ...
        healthcareSeries.addMenber(teamMedicalDragon);
        healthcareSeries.addMenber(doctorX);
